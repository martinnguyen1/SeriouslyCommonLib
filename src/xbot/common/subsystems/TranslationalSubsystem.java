...
public class TranslationalSubsystem extends BaseSubsystem
{
            ...
            PropertyManager propMan)
    {
        ...
        // These two PIDManagers will use the same properties underneath since we gave them the same name.
        // If you wanted to have different PID values for X and Y (if your robot behaved dramatically different
        // in each dimension), you could use two names like "Velocity X" and "Velocity Y".
        ...
        this.targetVelocityX = propMan.createEphemeralProperty("Target X velocity", 0d);
        this.targetVelocityY = propMan.createEphemeralProperty("Target Y velocity", 0d);
        ...
        this.enableTipPrevention = propMan.createPersistentProperty("Enable tip prevention", true);
    ...
    private void correctTargetPowerForTilt(XYPair correctedTargetPower) {
        ...
        XYPair tilt = pose.getTilt();
        XYPair tiltMax = pose.getMaxTilt();
    ...
    public void translatePowerFieldRelative(XYPair powerVector)
    {
        ...
        fieldRelativeVector.rotate(pose.FORWARD_ANGLE - pose.getCalibratedGyroYaw().getValue());
    ...
    {
        XYPair currVelocity = this.pose.getVelocityRobotRelative();
    ...
    public void translateVelocityFieldRelative(XYPair velocityTargetVector)
    {
        ...
        XYPair currVelocity = this.pose.getVelocityFieldRelative();
    ...
    public void goToFieldPositionAbsolute(XYPair targetPosition)
    {
        ...
        XYPair currentPosition = pose.getPosition();
